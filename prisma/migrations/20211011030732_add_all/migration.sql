/*
  ...
  - Made the column `sub_category` on table `categories` required. This step will fail if there are existing NULL values in that column.
...
*/
-- AlterTable
ALTER TABLE `categories` MODIFY `sub_category` JSON NOT NULL;
